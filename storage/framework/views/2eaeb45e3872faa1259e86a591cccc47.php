...
<div class="mySlides fade">
    <div class="numbertext"> 1/3</div>
     <img src="<?php echo e(asset('images/img1.png')); ?>"  class="slide-img">
...
<div class="value_section">
    <h2>Our Value<h2>
        <div class="value_container">
            <div class="value_box">
               <img src="<?php echo e(asset('images/symbol.jpg')); ?>" alt= "Avatar" class ="avatar">
                <p3 class="title">Creativity</p>
            </div>

            <div class="value_container">
            <div class="value_box">
                <img src="<?php echo e(asset('images/Quality_Craftsmanship.jpg')); ?>" alt= "Avatar" class ="avatar">
                <p3 class="title">Quality Craftsmanship</p>
            </div>

            <div class="value_container">
            <div class="value_box">
               <img src="<?php echo e(asset('images/Eco-Friendly_mindset.jpg')); ?>" alt= "Avatar" class ="avatar">
                <p3 class="title">Eco-Friendly mindset</p>
            </div>

            <div class="value_container">
            <div class="value_box">
                <img src="<?php echo e(asset('images/Custome-First_aproach.jpg')); ?>" alt= "Avatar" class ="avatar">
...
<?php /**PATH C:\Users\haide\Herd\Team_22\resources\views/aboutus.blade.php ENDPATH**/ ?>