...
<?php $component->withAttributes([]); ?>
 <div class="registerPage">
    <form action="<?php echo e(route('register.store')); ?>" method="POST" class="RegisterForm">
        <?php echo csrf_field(); ?>

        <div class="imgcontainer">
            <img src="<?php echo e(asset('images/img_avatar2.png')); ?>" alt="Avatar" class="avatar">
        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\haide\Herd\Team_22\resources\views/register.blade.php ENDPATH**/ ?>