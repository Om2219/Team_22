<x-layout>
    ...
    <div class="faq-master">
        ...
        <button class="questions" onclick="tog(this)">Can I track my order?
            <div class="faq_arrows">
                <img src="images/dropdown-arrow_faq.png" height="20" width="20">
                {{-- ONLY CHANGE THIS IF YOU'RE WILLING TO GET THE 
                ARROWS TO DISAPPEAR AND REAPPEAR UPON BUTTON CLICK --}}
                {{-- {{-- <img src="images/up-arrow_faq.png" height="20" width="20"> --}}
            </div>
        </button>
